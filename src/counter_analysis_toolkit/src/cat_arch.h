...
#define FMA_VEC_SBF16(_I_,_J_,_K_) _mm_fmadd_sbh( _I_ , _J_ , _K_ );
//#define DIV_VEC_SBF16(_I_,_J_)   _mm_div_sbh( _I_ , _J_ , _K_ );*/
...
#define FMA_VEC_PBF16(_I_,_J_,_K_) _mm_fmadd_pbh( _I_ , _J_ , _K_ );*/
...
/*#define SET_VEC_PBF16(_I_)       _mm512_set1_bf16( (__bf16)((float)_I_) );
#define ADD_VEC_PBF16(_I_,_J_)     _mm512_add_bf16( _I_ , _J_ );
#define MUL_VEC_PBF16(_I_,_J_)     _mm512_mul_bf16( _I_ , _J_ );
#define FMA_VEC_PBF16(_I_,_J_,_K_) _mm512_fmadd_bf16( _I_ , _J_ , _K_ );*/
...
#define FMA_VEC_PBF16(_I_,_J_,_K_) _mm256_fmadd_pbh( _I_ , _J_ , _K_ );*/

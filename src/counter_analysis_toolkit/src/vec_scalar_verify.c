...
fp16_half test_fp16_scalar_VEC_24( uint64 iterations, int EventSet, FILE *fp ){
    register FP16_SCALAR_TYPE r0,r1,r2,r3,r4,r5,r6,r7,r8,r9,rA,rB,rC,rD,rE,rF;
...
bf16_half test_bf16_scalar_VEC_24( uint64 iterations, int EventSet, FILE *fp ){
    register BF16_SCALAR_TYPE r0,r1,r2,r3,r4,r5,r6,r7,r8,r9,rA,rB,rC,rD,rE,rF;

    /* Generate starting data */
    r0 = SET_VEC_SBF16(0.01);
    r1 = SET_VEC_SBF16(0.02);
    r2 = SET_VEC_SBF16(0.03);
    r3 = SET_VEC_SBF16(0.04);
    r4 = SET_VEC_SBF16(0.05);
    r5 = SET_VEC_SBF16(0.06);
    r6 = SET_VEC_SBF16(0.07);
    r7 = SET_VEC_SBF16(0.08);
    r8 = SET_VEC_SBF16(0.09);
    r9 = SET_VEC_SBF16(0.10);
    rA = SET_VEC_SBF16(0.11);
    rB = SET_VEC_SBF16(0.12);
    rC = SET_VEC_SBF16(0.13);
    rD = SET_VEC_SBF16(0.14);
    rE = SET_VEC_SBF16(0.15);
    rF = SET_VEC_SBF16(0.16);
    ...
    while (c < iterations){
        ...
        while (i < ITER){
            ...
            /* The performance critical part */
            r0 = MUL_VEC_SBF16(r0,rC);
            r1 = ADD_VEC_SBF16(r1,rD);
            r2 = MUL_VEC_SBF16(r2,rE);
            r3 = ADD_VEC_SBF16(r3,rF);
            r4 = MUL_VEC_SBF16(r4,rC);
            r5 = ADD_VEC_SBF16(r5,rD);
            r6 = MUL_VEC_SBF16(r6,rE);
            r7 = ADD_VEC_SBF16(r7,rF);
            r8 = MUL_VEC_SBF16(r8,rC);
            r9 = ADD_VEC_SBF16(r9,rD);
            rA = MUL_VEC_SBF16(rA,rE);
            rB = ADD_VEC_SBF16(rB,rF);

            r0 = ADD_VEC_SBF16(r0,rF);
            r1 = MUL_VEC_SBF16(r1,rE);
            r2 = ADD_VEC_SBF16(r2,rD);
            r3 = MUL_VEC_SBF16(r3,rC);
            r4 = ADD_VEC_SBF16(r4,rF);
            r5 = MUL_VEC_SBF16(r5,rE);
            r6 = ADD_VEC_SBF16(r6,rD);
            r7 = MUL_VEC_SBF16(r7,rC);
            r8 = ADD_VEC_SBF16(r8,rF);
            r9 = MUL_VEC_SBF16(r9,rE);
            rA = ADD_VEC_SBF16(rA,rD);
            rB = MUL_VEC_SBF16(rB,rC);
    ...
    /* Use data so that compiler does not eliminate it when using -O2 */
    r0 = ADD_VEC_SBF16(r0,r1);
    r2 = ADD_VEC_SBF16(r2,r3);
    r4 = ADD_VEC_SBF16(r4,r5);
    r6 = ADD_VEC_SBF16(r6,r7);
    r8 = ADD_VEC_SBF16(r8,r9);
    rA = ADD_VEC_SBF16(rA,rB);

    r0 = ADD_VEC_SBF16(r0,r2);
    r4 = ADD_VEC_SBF16(r4,r6);
    r8 = ADD_VEC_SBF16(r8,rA);

    r0 = ADD_VEC_SBF16(r0,r4);
    r0 = ADD_VEC_SBF16(r0,r8);

    bf16_half out = 0;
    BF16_SCALAR_TYPE temp = r0;
...
fp16_half test_fp16_scalar_VEC_FMA_12( uint64 iterations, int EventSet, FILE *fp ){
    ...
    while (c < iterations){
        ...
        while (i < ITER){
            ...
            /* The performance critical part */
            r0 = FMA_VEC_SFP16(r0,r7,r9);
            r1 = FMA_VEC_SFP16(r1,r8,rA);
            r2 = FMA_VEC_SFP16(r2,r9,rB);
            r3 = FMA_VEC_SFP16(r3,rA,rC);
            r4 = FMA_VEC_SFP16(r4,rB,rD);
            r5 = FMA_VEC_SFP16(r5,rC,rE);

            r0 = FMA_VEC_SFP16(r0,rD,rF);
            r1 = FMA_VEC_SFP16(r1,rC,rE);
            r2 = FMA_VEC_SFP16(r2,rB,rD);
            r3 = FMA_VEC_SFP16(r3,rA,rC);
            r4 = FMA_VEC_SFP16(r4,r9,rB);
            r5 = FMA_VEC_SFP16(r5,r8,rA);
...
bf16_half test_bf16_scalar_VEC_FMA_12( uint64 iterations, int EventSet, FILE *fp ){
    ...
    while (c < iterations){
        ...
        while (i < ITER){
            ...
            /* The performance critical part */
            r0 = FMA_VEC_SBF16(r0,r7,r9);
            r1 = FMA_VEC_SBF16(r1,r8,rA);
            r2 = FMA_VEC_SBF16(r2,r9,rB);
            r3 = FMA_VEC_SBF16(r3,rA,rC);
            r4 = FMA_VEC_SBF16(r4,rB,rD);
            r5 = FMA_VEC_SBF16(r5,rC,rE);

            r0 = FMA_VEC_SBF16(r0,rD,rF);
            r1 = FMA_VEC_SBF16(r1,rC,rE);
            r2 = FMA_VEC_SBF16(r2,rB,rD);
            r3 = FMA_VEC_SBF16(r3,rA,rC);
            r4 = FMA_VEC_SBF16(r4,r9,rB);
            r5 = FMA_VEC_SBF16(r5,r8,rA);
    ...
    r0 = ADD_VEC_SBF16(r0,r6);
    r2 = ADD_VEC_SBF16(r2,r4);
